...
var buildVisualOnlyPrompt = function buildVisualOnlyPrompt(visualPrompt, card) {
  ...
  return "\u65E0\u6587\u5B57\u4E3B\u89C6\u89C9\u3002\u751F\u6210\u4E00\u5F20\u53EF\u4F5C\u4E3A\u6574\u5F20 3:4 \u5361\u7247\u5168\u5E45\u80CC\u666F\u7684\u8FDE\u7EED\u753B\u9762\uFF0C\u80CC\u666F\u81EA\u7136\u5EF6\u4F38\u5230\u56DB\u8FB9\uFF0C\u4E0D\u8981\u5185\u5D4C\u56FE\u7247\u6846\u3001\u6D77\u62A5\u8FB9\u6846\u6216\u72EC\u7ACB\u5361\u7247\u5BB9\u5668\u3002\u4E3B\u4F53\u653E\u5728\u4E2D\u5FC3\u504F\u4E0B\uFF0C\u9876\u90E8\u4FDD\u7559\u4F4E\u7EC6\u8282\u3001\u660E\u6697\u7A33\u5B9A\u7684\u6587\u5B57\u5B89\u5168\u533A\u3002\u53EA\u4FDD\u7559\u5E76\u751F\u6210\u4EE5\u4E0B\u573A\u666F\u6216\u63D2\u56FE\u5143\u7D20\uFF1A".concat(sceneDescription || '围绕卡片核心比喻设计一个主体明确、构图简洁的视觉场景', "\u3002\u4E0D\u5F97\u51FA\u73B0\u4EFB\u4F55\u6587\u5B57\u3001\u5B57\u6BCD\u3001\u6570\u5B57\u3001\u7B26\u53F7\u3001Logo\u3001\u6C34\u5370\u3001\u5361\u7247\u6846\u67B6\u3001UI\u3001\u4FE1\u606F\u6761\u6216\u4F2A\u6587\u5B57\u7EB9\u7406\uFF1B\u4E0D\u8981\u7ED8\u5236\u6807\u9898\u3001\u8981\u70B9\u3001\u603B\u7ED3\u548C\u6309\u94AE\u6807\u7B7E\u3002");
};
...
var ResultsPanel = React.memo(function (_ref6) {
...
function App() {
  ...
  var handleTestTextConnection = function () {
    var _handleTestTextConnection = _asyncToGenerator(_regenerator().m(function _callee1() {
      var endpoint, model, apiKey, startedAt, _data$error2, messages, response, data, responseText, elapsedMs, preview, _t4;
  ...
  var handleGenerateImage = function () {
    var _handleGenerateImage = _asyncToGenerator(_regenerator().m(function _callee10(cardTitle, prompt) {
      var mode,
        resultKey,
        imageEndpoint,
        diagnosticPhase,
      ...
      return _regenerator().w(function (_context10) {
        while (1) switch (_context10.p = _context10.n) {
          case 0:
            mode = _args10.length > 2 && _args10[2] !== undefined ? _args10[2] : 'visual';
    ...
    function handleGenerateImage(_x10, _x11) {
  ...
  var exportHtmlCard = function () {
    var _exportHtmlCard = _asyncToGenerator(_regenerator().m(function _callee11(card) {
      var visualResult, sourceNode, canvas, pngBlob, pngUrl, _t7;
  ...
  var requestProcessingText = function () {
    var _requestProcessingText = _asyncToGenerator(_regenerator().m(function _callee12(messages) {
      var fullResponseText, rawBuffer, isStreamedData, finishReason, endpoint, response, errorMsg, _errorData$error, errorData, reader, decoder, streamBuffer, _yield$reader$read, done, value, dataStr, data, chunk, lines, _iterator2, _step2, _loop, _ret, _data2, parsed, _t9, _t0;
      return _regenerator().w(function (_context13) {
        while (1) switch (_context13.p = _context13.n) {
          ...
          case 11:
            ...
            return _context13.d(_regeneratorValues(_loop()), 12);
          case 12:
            _ret = _context13.v;
            if (!(_ret === 0)) {
              _context13.n = 13;
      ...
      }, _callee12, null, [[10, 15, 16, 17], [2, 4]]);
    }));
    function requestProcessingText(_x13) {
      return _requestProcessingText.apply(this, arguments);
    }
    return requestProcessingText;
  }();
  var handleStartProcessing = function () {
    var _handleStartProcessing = _asyncToGenerator(_regenerator().m(function _callee13() {
      var overrideText,
        textToProcess,
        newSessionId,
        initialMessages,
      ...
      return _regenerator().w(function (_context14) {
        while (1) switch (_context14.p = _context14.n) {
          ...
          case 12:
            ...
            _t10 = _context14.v;
            setToast({
              message: "\u5F15\u64CE\u8FDE\u63A5\u5931\u8D25: ".concat(_t10.message),
              type: 'error',
              duration: 5000
            });
          case 13:
      ...
      }, _callee13, null, [[8, 10], [4, 12, 13, 14]]);
    }));
  ...
  var loadHistoryItem = function () {
    var _loadHistoryItem = _asyncToGenerator(_regenerator().m(function _callee14(id) {
    ...
    function loadHistoryItem(_x14) {
      return _loadHistoryItem.apply(this, arguments);
    }
    return loadHistoryItem;
  }();
  var retryHistoryItem = function () {
    var _retryHistoryItem = _asyncToGenerator(_regenerator().m(function _callee15(id) {
      var item;
    ...
    function retryHistoryItem(_x15) {
  ...
  var copyToClipboard = function () {
    var _copyToClipboard = _asyncToGenerator(_regenerator().m(function _callee16(text, label) {
      ...
      }, _callee16, null, [[5, 7], [1, 4]]);
    }));
    function copyToClipboard(_x16, _x17) {
      ...
      return React.createElement("div", {
        ...
        if (promptSections.length > 0) {
          ...
          return React.createElement("div", {
            ...
            style: {
              aspectRatio: (imageResult.size || apiConfig.imageSize || '768x1024').replace('x', ' / ')
            }
            ...
            className: "visual-preview",
            style: {
              aspectRatio: (fullImageResult.size || apiConfig.imageSize || '768x1024').replace('x', ' / ')
            }
          }, React.createElement("img", {

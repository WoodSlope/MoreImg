...
var assessAnalysisDepth = function assessAnalysisDepth(parsed) {
  ...
  var requiredStage3Length = Math.min(1200, Math.max(360, Math.floor(inputLength * 0.5)));
  return {
    isAdequate: stageLengths[0] >= 60 && stageLengths[1] >= 180 && stageLengths[2] >= requiredStage3Length,
...
var buildProcessingMessages = function buildProcessingMessages(originalText, previousResponse) {
  ...
  return [{
    ...
    role: 'user',
    content: '上一次输出不完整或深度不足。请重新从阶段1开始，严格连续输出到阶段6。阶段1要分项给出判型依据，不得只给出一句结论；阶段2要完整输出核查与内容骨架；阶段3要输出可独立发布的完整精修文章，不得缩写为摘要。阶段4必须包含封面卡片、至少一张正文卡片和封底卡片，阶段5必须包含与卡片一一对应的封面、正文和封底拆分提示词。不要解释重试原因，直接输出完整结果。'
  }];
};
...
var buildVisualOnlyPrompt = function buildVisualOnlyPrompt(visualPrompt, card) {
  ...
  var safeArea = (card === null || card === void 0 ? void 0 : card.type) === 'cover' ? '顶部45%' : '顶部55%';
  return "\u65E0\u6587\u5B57\u4E3B\u89C6\u89C9\u3002\u751F\u6210\u4E00\u5F20\u53EF\u4F5C\u4E3A\u6574\u5F20 3:4 \u5361\u7247\u5168\u5E45\u80CC\u666F\u7684\u8FDE\u7EED\u753B\u9762\uFF0C\u80CC\u666F\u81EA\u7136\u5EF6\u4F38\u5230\u56DB\u8FB9\uFF0C\u4E0D\u8981\u5185\u5D4C\u56FE\u7247\u6846\u3001\u6D77\u62A5\u8FB9\u6846\u6216\u72EC\u7ACB\u5361\u7247\u5BB9\u5668\u3002\u4E3B\u4F53\u5B8C\u6574\u96C6\u4E2D\u5728\u4E0B\u534A\u90E8\uFF0C".concat(safeArea, "\u4FDD\u7559\u4F4E\u7EC6\u8282\u3001\u660E\u6697\u7A33\u5B9A\u7684\u6587\u5B57\u5B89\u5168\u533A\uFF1B\u5E95\u90E8\u53EA\u5C55\u793A\u4E3B\u89C6\u89C9\uFF0C\u4E0D\u9884\u7559\u6587\u5B57\u4F4D\u7F6E\u3002\u53EA\u4FDD\u7559\u5E76\u751F\u6210\u4EE5\u4E0B\u573A\u666F\u6216\u63D2\u56FE\u5143\u7D20\uFF1A").concat(sceneDescription || '围绕卡片核心比喻设计一个主体明确、构图简洁的视觉场景', "\u3002\u4E0D\u5F97\u51FA\u73B0\u4EFB\u4F55\u6587\u5B57\u3001\u5B57\u6BCD\u3001\u6570\u5B57\u3001\u7B26\u53F7\u3001Logo\u3001\u6C34\u5370\u3001\u5361\u7247\u6846\u67B6\u3001UI\u3001\u4FE1\u606F\u6761\u6216\u4F2A\u6587\u5B57\u7EB9\u7406\uFF1B\u4E0D\u8981\u7ED8\u5236\u6807\u9898\u3001\u8981\u70B9\u3001\u603B\u7ED3\u548C\u6309\u94AE\u6807\u7B7E\u3002");
};
...
var isLegacyDefaultPrompt = function isLegacyDefaultPrompt(prompt) {
  ...
  return normalized.includes('角色定位：') && normalized.includes('核心工作流') && normalized.includes('阶段1：原料接收与判型') && normalized.includes('阶段6：交付后质量自检') && normalized.includes('激活指令：') && !normalized.includes('阶段1不得只输出“通过”或一句概括');
};
...
function App() {
  ...
  }, React.createElement("strong", null, "\u68C0\u6D4B\u5230\u65E7\u7248\u9ED8\u8BA4\u6307\u4EE4"), "\u65B0\u7248\u8865\u5145\u4E86\u9636\u6BB51\u81F33\u6DF1\u5EA6\u8981\u6C42\u3001\u5B8C\u6574\u6027\u68C0\u67E5\u548C\u957F\u8F93\u51FA\u7EA6\u675F\u3002\u5347\u7EA7\u524D\u4E0D\u4F1A\u8986\u76D6\u5F53\u524D\u5185\u5BB9\u3002"), React.createElement("button", {
    type: "button",
